...
// flex-direction
const btnRow = document.querySelector(".nav__btn__fd-row"), btnRowReverse = document.querySelector(".nav__btn__fd-row-reverse"), btnColumn = document.querySelector(".nav__btn__fd-column"), btnColumnReverse = document.querySelector(".nav__btn__fd-column-reverse");
...
// gap
const btnGap = document.querySelector(".nav__btn__gap-on"), btnNoGap = document.querySelector(".nav__btn__gap-off"), btnRowGap = document.querySelector(".nav__btn__gap-row"), btnColumnGap = document.querySelector(".nav__btn__gap-column");
...
// align-content
const btnAcStart = document.querySelector(".nav__btn__ac-start"), btnAcCenter = document.querySelector(".nav__btn__ac-center"), btnAcEnd = document.querySelector(".nav__btn__ac-end"), btnAcBetween = document.querySelector(".nav__btn__ac-between"), btnAcAround = document.querySelector(".nav__btn__ac-around");
...
// justify-content
const btnJcStart = document.querySelector(".nav__btn__jc-start"), btnJcCenter = document.querySelector(".nav__btn__jc-center"), btnJcEnd = document.querySelector(".nav__btn__jc-end"), btnJcBetween = document.querySelector(".nav__btn__jc-between"), btnJcAround = document.querySelector(".nav__btn__jc-around"), btnJcEvenly = document.querySelector(".nav__btn__jc-evenly");
